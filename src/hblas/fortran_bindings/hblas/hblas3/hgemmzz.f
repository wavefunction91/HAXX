...
C     See LICENSE.txt 
C
      Subroutine HGEMMZZ(TRANSA, TRANSB, M, N, K, ALPHA, A, LDA,
     $  B, LDB, BETA, C, LDC)
C
      LOGICAL LSAME
      EXTERNAL LSAME
C
     ...
     $          BZERO, BONE
      ...
      Complex*16    A(2,LDA,*), B(2,LDB,*), C(2,LDC,*), ALPHA, BETA
C
...
C
            ...
            ELSE
              C(1,I,J) = ALPHA*HTMP1S + BETA * C(1,I,J)
              C(2,I,J) = ALPHA*HTMP1J + BETA * C(2,I,J)
            ENDIF
  80      CONTINUE
        ELSE
C         IMPLIES TRANSA == 'T'
