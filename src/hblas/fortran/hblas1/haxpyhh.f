...
C     See LICENSE.txt 
C
      Subroutine HAXPYHH(SIDE, N, ALPHA, X, INCX, Y, INCY)
C
      LOGICAL LSAME
      EXTERNAL LSAME
C
...
C           Hamilton Product
     ...
     $                        X(3,I)*ALPHA(4) - X(4,I)*ALPHA(3)
            ...
            Y(3,I) = Y(3,I) + X(1,I)*ALPHA(3) - X(2,I)*ALPHA(4) +
     $                        X(3,I)*ALPHA(1) + X(4,I)*ALPHA(2)
                                                     
            Y(4,I) = Y(4,I) + X(1,I)*ALPHA(4) + X(2,I)*ALPHA(3) -
...
C           Hamilton Product
     ...
     $                          X(3,IX)*ALPHA(4) - X(4,IX)*ALPHA(3)
            ...
            Y(3,IY) = Y(3,IY) + X(1,IX)*ALPHA(3) - X(2,IX)*ALPHA(4) +
     $                          X(3,IX)*ALPHA(1) + X(4,IX)*ALPHA(2)
                                                     
            Y(4,IY) = Y(4,IY) + X(1,IX)*ALPHA(4) + X(2,IX)*ALPHA(3) -
