...
// TPACK2, no scalar
inline void TPACK2_T1(const HAXX_INT M, const HAXX_INT N, 
  ...
  do {
    ...
    for( i = 0; i < M; i++ ) {
      ...
      __m256d x_SISI = _mm256_permute2f128_pd(x1,x2, 0x20);
      __m256d x_JKJK = _mm256_permute2f128_pd(x1,x2, 0x31);
  ...
  if( N % 2 ) {
    for( i = 0; i < M; i++ ) {
      ...
      __m256d x_SISI = _mm256_permute2f128_pd(x,xz, 0x20);
      __m256d x_JKJK = _mm256_permute2f128_pd(x,xz, 0x31);
      STORE_256D_ALIGNED_AS(double,_xp  ,x_SISI);
      STORE_256D_ALIGNED_AS(double,_xp+1,x_JKJK);
...
inline void TPACK2_T1(const double ALPHA, const HAXX_INT M, 
...
inline void TPACK2_T1(const std::complex<double> ALPHA, 
...
inline void TPACKC2_T1(const HAXX_INT M, const HAXX_INT N, 
  quaternion<double> *X, const HAXX_INT LDX, 
  quaternion<double> *Xp) {
...
inline void TPACKC2_T1(const double ALPHA, const HAXX_INT M, 
  const HAXX_INT N, quaternion<double> *X, 
  const HAXX_INT LDX, quaternion<double> *Xp) {
...
inline void TPACKC2_T1(const std::complex<double> ALPHA, 
  const HAXX_INT M, const HAXX_INT N, quaternion<double> *X, 
  const HAXX_INT LDX, quaternion<double> *Xp) {
...
// NPACK2, no scalar
inline void NPACK2_T1(const HAXX_INT M, const HAXX_INT N, 
  quaternion<double> *X, const HAXX_INT LDX, 
  quaternion<double> *Xp) {
...
inline void NPACK2_T1(const double ALPHA, const HAXX_INT M, 
  const HAXX_INT N, quaternion<double> *X, 
  const HAXX_INT LDX, quaternion<double> *Xp) {
...
inline void NPACK2_T1(const std::complex<double> ALPHA, 
  const HAXX_INT M, const HAXX_INT N, quaternion<double> *X, 
  const HAXX_INT LDX, quaternion<double> *Xp) {
...
inline void NPACKC2_T1(const HAXX_INT M, const HAXX_INT N, 
  quaternion<double> *X, const HAXX_INT LDX, 
  quaternion<double> *Xp) {
...
inline void NPACKC2_T1(const double ALPHA, const HAXX_INT M, 
  const HAXX_INT N, quaternion<double> *X, 
  const HAXX_INT LDX, quaternion<double> *Xp) {
...
inline void NPACKC2_T1(const std::complex<double> ALPHA, 
  const HAXX_INT M, const HAXX_INT N, quaternion<double> *X, 
  const HAXX_INT LDX, quaternion<double> *Xp) {
